...
<p align="center">
  <img src="results/swin_unet_architecture_pub_v2.png" width="750"/>
</p>
...
- **Latitude-weighted L1 Loss:**  
  ![lat-L1](results/lat_l1_formula.png)
- **RMSE:**  
  ![RMSE](results/rmse_formula.png)
- **ACC:**  
  ![ACC](results/acc_formula.png)
